...
namespace Vale.Tops.Application.Presentation.AssetManager.Extensions
{
    public static class ClaimsExtensions
    {
        static string GetUserEmail(this ClaimsIdentity identity)
        {
            return identity.Claims?.FirstOrDefault(c => c.Type == "Vale.Tops.Application.Presentation.AssetManager.Models.RegisterViewModel.Email")?.Value;
        }
        ...
        {
            return identity.Claims?.FirstOrDefault(c => c.Type == "Vale.Tops.Application.Presentation.AssetManager.Models.RegisterViewModel.NameIdentifier")?.Value;
        }
