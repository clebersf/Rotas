...
{
    public class LogbookEPViewModel : LogbookViewModel
    {
        /*[Display(Name = "Sim")]
        ...
        [Display(Name = "Baliza Inicial do Lote")]
        public int? LotSLandmarkInitial { get; set; }
        
        [Display(Name = "Baliza Final do Lote")]
        ...
        [Display(Name ="Taxa baixa ou Paralização")]
