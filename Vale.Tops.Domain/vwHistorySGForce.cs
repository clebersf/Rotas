...
namespace Vale.Tops.Domain
{
    ...
    [Table("vwHistorySGForce")]
    public partial class vwHistorySGForce : Entity
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public vwHistorySGForce()
        {
        }
        [Key]
        public DateTime dh { get; set; }
        public long Realizado { get; set; }
        public long Removido { get; set; }

        public long AccRemovido { get; set; }

        public long AccRealizado { get; set; }
